...
class TestHat(TestCase):
    ...
    def test_illuminate(self):
        ...
        self.assertEqual(self.hat.lights[50], (127, 0, 0))  # noqa: PT009
        self.assertEqual(self.hat.lights[12], (126, 0, 0))  # noqa: PT009
        self.assertEqual(self.hat.lights[62], (109, 0, 0))  # noqa: PT009
        self.assertEqual(self.hat.lights[36], (107, 0, 0))  # noqa: PT009
