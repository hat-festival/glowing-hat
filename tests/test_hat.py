...
class TestHat(TestCase):
    ...
    def test_illuminate(self):
        ...
        self.assertEqual(self.hat.lights[50], (63, 0, 0))  # noqa: PT009
        self.assertEqual(self.hat.lights[12], (63, 0, 0))  # noqa: PT009
        self.assertEqual(self.hat.lights[62], (54, 0, 0))  # noqa: PT009
        self.assertEqual(self.hat.lights[36], (53, 0, 0))  # noqa: PT009
